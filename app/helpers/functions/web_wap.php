...
function nav_danceng($tpl='<li><a href="__URL__" title="%catname%">%catname%</a></li>')
{
	global $pid,$ty;
	...
	$data = M('news_cats')->field('catname,id')->where('pid = 0 and id <=6')->order('disorder desc,id asc')->select();
