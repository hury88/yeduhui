...
return [
    ...
    'other'                  => [
        ...
        'nocontent'  => '<p style="text-align:center;padding:38px 0;">内容更新中</p>',
    ...
    'lang'                  => [
        ...
        'lookup_failed'  => '找回失败)^(',
        #提交
        'message_success' => '信息提交成功',
        'message_failed'  => '信息提交失败,请稍后再试',
        #登陆
        ...
        'medical_budget' => '请填写 预计资金',
        'medical_bookMedicalId' => '请选择 医疗项目',
        'medical_symptoms' => '请填写 身体症状',
        'medical_problem' => '请填写 解决问题',

        // 预约
        'booking_reserveProject' => '请选择 预约项目',
        'booking_reserveStore' => '请选择 预约门店',
        'booking_reserveManage' => '请选择 预约调理师',
        'booking_reserveTime' => '请填写 预约时间',

        'hezuo_hezuoStyle' => '请填写 合作形式',
        'hezuo_position' => '请填写 合作门店位置',
        'hezuo_idea' => '请填写 具体合作思路',
