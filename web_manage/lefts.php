...
<head>
  ...
  <link href="js/layer/layui/css/layui.css" rel="stylesheet" media="all">
...
<body  style="background-color:#f1f9ff;">
  ...
  <ul class="yiji clr">
    ...
    <?php }else {
          ...
          <ul class="erji clr" style="display:none">
            ...
            foreach ($data2 as $key2 => $bd2) {
              ...
              if(!empty($bd2['linkurl']))
                ...
                $linkurl = getUrl(array('pid'=>$bd2['pid'],'ty'=>$bd2['id']),config('webarr.showtype2')[$showtype]);
              ...
              foreach ($data3 as $key3 => $bd3) {
                ...
                if(!empty($bd3['linkurl']))
                  ...
                  $linkurl2 = getUrl(array('pid'=>$pid,'ty'=>$ppid,'tty'=>$bd3['id']),config('webarr.showtype2')[$showtype]);
                ?>
      ...
      <script type="text/javascript" src="js/layer/layer/layerSilica.js"></script>
      <script>
        var _ls = layerSilica;
        $('.tt a').click(function(){
